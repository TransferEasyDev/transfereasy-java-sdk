...
import main.java.com.transfereasy.entity.invoice.Callback;
...
public class CallBackVerify {
    ...
    private static ArrayList<Object> listToTreeMap(ArrayList<Object> lst) throws Exception {
        ArrayList<Object> rstList = new ArrayList<>();
        for (Object aLst : lst) {
            if (aLst instanceof Data) {
                rstList.add(objectToTreeMap(aLst));
            } else {
                rstList.add(aLst);
            }
        }
    ...
    private static TreeMap<String, Object> objectToTreeMap(Object obj) throws Exception {
        if(obj == null){
            return null;
        }
        ...
        for (Field field : declaredFields) {
            ...
            if (field.get(obj) instanceof Data) {
                TreeMap<String, Object> sub_map = objectToTreeMap(field.get(obj));
                map.put(field.getName(), sub_map);
            }
            else if(field.get(obj) instanceof ArrayList){
                System.out.println("*******");
                System.out.println(field.get(obj));
                map.put(field.getName(), listToTreeMap((ArrayList<Object>) field.get(obj)));
    ...
    public static void main(String[] args) throws Exception {
        ...
        Callback callback = gson.fromJson(paramStr, Callback.class);
         ...
         * */
        TreeMap<String, Object> map = CallBackVerify.objectToTreeMap(callback);
