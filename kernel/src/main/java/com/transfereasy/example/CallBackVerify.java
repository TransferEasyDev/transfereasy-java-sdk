...
public class CallBackVerify {
    public static void main(String[] args) throws Exception {
        ...
        entity.put("created", "2018-10-09 14:48:42");
        entity.put("escrow_account", "escrow_account");
        entity.put("fee_amount", 0.0);
        entity.put("fee_currency", "USD");

        System.out.println(entity.keys());

        /*
         * {
         * 	"entity": {
         * 		"created": "2018-10-09 14:48:42",
         * 		"escrow_account": {
         * 			"bank": {
         ...
         * 			"bank_name": "",
         * 			"dob": "2018-10-09",
         * 			"document_number": "123543636",
         * 			"document_type": "CHN/ID",
         * 			"email": "123@test.com",
