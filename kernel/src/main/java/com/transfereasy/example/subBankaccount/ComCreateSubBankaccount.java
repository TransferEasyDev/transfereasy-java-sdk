...
public class ComCreateSubBankaccount {
    public static void main(String[] args) throws IOException,JSONException {
        ...
        params.addBinaryBody("license_file", new File("/Users/kongfm/Desktop/upload.png"));
        params.addBinaryBody("office_reg_addr_evd_file", new File("/Users/kongfm/Desktop/upload.png"));
        params.addBinaryBody("beneficiary_evd_file", new File("/Users/kongfm/Desktop/upload.png"));
        params.addBinaryBody("bank_cert_evd_file", new File("/Users/kongfm/Desktop/upload.png"));
        params.addBinaryBody("contact_doc_file", new File("/Users/kongfm/Desktop/upload.png"));
        params.addBinaryBody("contact_address_file", new File("/Users/kongfm/Desktop/upload.png"));

        ApplyResponse response = sbacc.comCreateSubBankAccount(params);
